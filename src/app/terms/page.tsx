  ...
  return (
    <div className="container-page py-8 max-w-3xl">
      ...
      <div className="prose-ccc space-y-5">
        ...
        <ul>
          <li>CCC Guru is provided for educational purposes only.</li>
        ...
        <h2>Content</h2>
        <p>
          All content on CCC Guru (tests, notes, blogs, books) is created for educational purposes.
          We do not guarantee 100% accuracy of all content. Always verify important information
          from official NIELIT sources.
        </p>
        <h2>Disclaimer</h2>
        <p>
          CCC Guru is an independent educational platform and is not affiliated with or endorsed
